...
<div class="container">
  ...
  <h1 class="alert alert-danger">フルーツ課題 PHP編 回答</h1>
  ...
  <?php
    ...
    // answer
    $fruitsA = ['メロン', 'メロン', 'メロン', 'メロン', 'メロン', 'メロン', 'メロン', 'りんご', 'りんご', 'りんご', 'みかん', 'みかん', 'みかん', 'いちご', 'いちご', 'いちご', 'バナナ'];
    $numberA = rand(0, 16); // PHPのランダム関数を使っている
  ?>
  ...
  <div class="card">
    ...
    <div class="card-body">
      <ul class="list-group list-group-horizontal">
        <?php foreach( $fruits as $k => $v ){ ?>
          <li class="list-group-item <?php echo $colors[$k]; ?>"><?php echo $v; ?></li>
        <?php } ?>
      </ul>
    </div>
    <div class="card-footer">
