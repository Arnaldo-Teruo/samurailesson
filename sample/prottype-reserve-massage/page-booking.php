      ...
      <div class="card border-top">
        <div class="card-body">
          ...
          <div class="text-center text-sm-right">
            <a href="<?php echo home_url(); ?>/timetable/" class="btn btn-outline-secondary mb-4">
              メニューと日時選択へ戻る
            </a>
          </div>
          <form action="<?php echo home_url(); ?>/save/" method="post">
            ...
            <div class="d-flex justify-content-center my-4">
              <a href="<?php echo home_url(); ?>/timetable/" class="btn btn-secondary text-white mr-5">戻る</a>
