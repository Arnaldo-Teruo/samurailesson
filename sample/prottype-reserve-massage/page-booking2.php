...
<div id="app">
  ...
  <section class="py-4">
    <div class="container">
      <div class="card">
        <div class="card-body">
          <form action="<?php echo home_url(); ?>/save/" method="post">
            <?php wp_nonce_field( 'reservationAction', 'reservationField' ); ?>
            <div class="row pb-4">
              ...
              <div class="col-12 col-md-9 d-flex">
                ...
                <!-- <div class="form-group mr-4">
                  <select name="plan" v-model="selectedPlan" @change="setPlanTime()" class="form-control">
                    <option value="">選択して下さい</option>
                    <option v-for="v in plan" :value="v.title">{{ v.title }}</option>
                  </select>
                </div> -->
              </div>
            </div>
            ...
            <div class="d-flex justify-content-around my-4">
              <a href="<?php echo get_stylesheet_directory_uri(); ?>/schedule/" class="btn btn-secondary text-white mr-5">戻る</a>
...
<script>
  var app = new Vue ({
    el: '#app',
    data: {
      plan: <?php include_once 'inc/plan.json'; ?>,
