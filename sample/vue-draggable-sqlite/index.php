...
// $data2 = getListDataSqlite();
// $data = getListDataConverted();
// echo '<pre>';
// print_r($data2);
// echo '</pre>';
// echo '<pre>';
      ...
      <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
          ...
          <div class="modal-footer">
            ...
            <button type="button" class="btn btn-primary" @click="addList()" data-dismiss="modal">保存する</button>
          </div>
        </div>
      </div>
    </div>
            ...
            <div class="card-body">
              <draggable tag="ul" class="list-group p-3" :options="{group:'ITEMS', handle:'.handle'}" v-model="list.col1">
                <li v-for="(v, i) in list.col1" :key="i" @dragstart="dragStart(v)" class="list-group-item d-flex justify-content-between align-items-center">
                  ...
                  <button class="btn btn-danger" @click="doDelete(v.id)">削除</button>
                </li>
              </draggable>
            </div>
          </div>
